...
export class FormBuilder {
    ...
    registerAsMenu({moduleId, key = "settings", name = "Configuration Menu", label = "Configure", icon = "fas fa-cogs", hint = "Configure the module settings", scope = "world", restricted = true, defaultValue = {}, onChange, requiresReload = false} = {}) {
    ...
    title(title) {
        this.#options.window.title = game.i18n.localize(title);
        return this;
    }
